...
public class Constants : MonoBehaviour
{
    ...
    public List<GameObject> minimapYellowFragments = new List<GameObject>();
    public List<GameObject> minimapBlueFragments = new List<GameObject>();
    public List<GameObject> minimapOrangeFragments = new List<GameObject>();
    public List<GameObject> minimapGreenFragments = new List<GameObject>();
    public List<GameObject> minimapPurpleFragments = new List<GameObject>();
    ...
    //colors
    public Material minimapKeyColor;
    public Material minimapRedFragmentColor;
    public Material minimapYellowFragmentColor;
    public Material minimapBlueFragmentColor;
    public Material minimapOrangeFragmentColor;
